...
/**
 * This class simulates the operations of an airport, including managing 
 * landing and takeoff queues, tracking airplane movements, and 
...
public class Airport
{
    ...
    */
    ...
    /*
     * deBugprint Writes a string to the debug output file
    */
    ...
    /*
     * simulateAll Simulates all actions in the airport for the current time
    */
    private void simulateAll()
    {
        ...
        deBugprint("minutes: " + Integer.toString(currentTime) + 
												",  landing prob: "+ 
        ...
        /*
			if takeOffRand < probOfTakeoff a plane gets added to the 
			takeoff queue
		*/
		...
		//checks to see if runway is clear
		...
		/*
			the if else if else statements bellow are orginized in 
			order of moset importance to lest inportance 
		*/
        ...
        else if(!landingQueue.isEmpty())
        {
			...
			/*
				this for loop removes crashed planes from landing queue until 
				there is a plan that has crashed or queue is empty
				
				this loop makes sure there aren't any crashed planes still 
				in the queue at the end of the simulation
			*/
            for (Airplane temp = landingQueue.peek(); temp != null &&  
			maxTimeLandingQueue < (currentTime - temp.getArrivalTime()); )
            {
                ...
                //prints to debug file 
                deBugprint("minutes: " + Integer.toString(currentTime) + 
									" plane " + temp +  " has crahed");
                //printd to debug file
                deBugprint("plane "+ temp + " has crashed and spent " 
										+ temp.getTimeInLandingQueue() + 
										" minutes in the landing queue");
            ...
            /*
				checks to see if there is a plane in the ques after 
				crashed planes have been removed
			*/
            if(!landingQueue.isEmpty()) 
            {
                ...
                //prints to debug file
                deBugprint("minutes: " + Integer.toString(currentTime) + 
									" plane " + temp +  " has lannded");
                //prints to debug file
                deBugprint("plane "+ temp + " spent " 
								+ temp.getTimeInLandingQueue() + 
								"minutes in the landing queue");
        ...
        else if(!takeoffQueue.isEmpty())
        {
            ...
            //print to debug file
            deBugprint("minutes: " + Integer.toString(currentTime) + 
									" plane " + temp +  " taken off");
            //print to debug file
            deBugprint("plane "+ temp + " spent " +temp.getTimeInTakeoffQueue() 
								+ "minutes in the takeoff queue");
    ...
    /*
     *  getInputs Reads inputs from the user
    */
    ...
    /*
     * displayResults Displays simulation results
    */
    private void displayResults()
    {
        ...
        System.out.println("The number of planes that "+	
							"took off in the simulated time");
        System.out.println(arraytookoff.size());

        //prints the amount of planes that landed
        System.out.println("the number of planes that landed "+	
        ...
        /*
            the loop below adds all remaining plans waiting to land to 
			take off to the array took off to the calculate the 
			average wait time   
        */
        avgTakeOffTime = 0;
        ...
        */
        ...
        {
			//accumulates time to calculate avgTakeOffTime
            temp = arraytookoff.remove(0);
            avgTakeOffTime = avgTakeOffTime + temp.getTimeInTakeoffQueue();
        }

        
        System.out.println("the average time that a plane "+
								"spent in the takeoff queue");
        try
        {
			//prints results to user after calculation
