...
public class Airport
{
    ...
    */
    private void simulateAll()
    {
        ...
        else if(!landingQueue.isEmpty())
        {
            ...
            /*
                if crashed planes should stay in the queue till there turn
                if(plane is crashed)
                {
    ...
    */
    private void displayResults()
    {
        ...
        {
            System.out.println("Divide by zero error" ); // to fix this do use the takeoff queue becuse of no planes take off they wont get added to the arraytookoff
        }
