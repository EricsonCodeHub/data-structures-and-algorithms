/**
 * The Airplane class represents an airplane, the class stores and set 
...
public class Airplane {
    ...
    */
    ...
    /**
     * Sets the takeoff time of the Airplane and calculates the 
     * time spent in the takeoff queue
	 * 
    ...
    */
    public void setTakeOffTime(int currentTime)
    {
		...
		//calculates and sets timeInTakeoffQueue
        timeInTakeoffQueue = takeoffTime - arrivalTime;
    }

    /**
     * Sets the landing time of the Airplane and calculates the 
     * time spent in the landing queue.
	 *
    ...
    */
    public void setLandTime(int currentTime)
    {
		...
		//calculates and sets timeInLandingQueue
