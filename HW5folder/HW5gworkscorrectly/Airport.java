...
public class Airport
{
    ...
    */
    private void displayResults()
    {
        ...
        /*
            the loop bellow adds all reming plans waitinf to land to take off to the 
            arraytookoff to the calculate the avarage wait time 
        */
        while(!takeoffQueue.isEmpty()) 
        {
            temp = takeoffQueue.remove();
            temp.setTakeOffTime(currentTime);
            arraytookoff.add(temp);
        }
        ...
        */
        ...
        {
            /*
                it is very unlikley this code will be exicuted,
                it could exicute when the simulation time is very low 
        ...
        {
            /*
                it is very unlikey this code will exicute,
                it could exicute if the run time is very low and the 
